...
\end{itemize}%
\sqlSyntax{4-}{syntax/create_table.sql}{0.05}{0.4}{0.9}{0.6}%
\end{frame}
%
\begin{frame}[t]%
...
\end{itemize}%
\sqlSyntax{2-}{syntax/insert_into.sql}{0.05}{0.3}{0.9}{0.6}%
\end{frame}
%
%
\begin{frame}[fragile,t]
...
\end{itemize}%
\sqlSyntax{3-}{syntax/select_from_where.sql}{0.05}{0.4}{0.9}{0.6}%
\end{frame}
%
%
\begin{frame}[fragile,t]
