...
\toggleToGerman%
%
\subtitle{16.~Von Python auf PostgreSQL Zugreifen}%
%
\begin{document}%
%
...
\begin{itemize}%
\item Datenbanken sind einige der wichtigsten Komponenten des IT-Ökosystems von Organisationen.%
...
\item<2-> Er existiert für String-Literale, also Strings, die wir \inQuotes{genau so in den Quelltext hingeschrieben haben.}%
...
\item<3-> Die Idee ist, das statische Typ-Checker in Zukunft festellen so können, ob ein String ein Literal ist oder das Ergebnis von String-Operationen und Fehler in Sicherheitskritischen Situation anzeigen können~\cite{PEP675,VDGE2022PPDAFP:ST}.%
...
\only<-7>{%
\item<2-> Es würde aber wenig Sinn ergeben, wenn wir nur \sql-Kommandos verwenden dürften, die hart-kodierte String-Literale sind.%
