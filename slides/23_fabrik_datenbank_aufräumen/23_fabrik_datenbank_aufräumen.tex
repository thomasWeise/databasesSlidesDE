...
%
\item<3-> Weil sie einige interessante Verwendungen hat.%
%
...
Because it has some interesting use cases\cite{PGDG:PD:SD}.%
%
...
Running this script would re-create the \glsShort{db} in exactly its present state.
\end{itemize}%
\end{frame}%
%
\begin{frame}%
