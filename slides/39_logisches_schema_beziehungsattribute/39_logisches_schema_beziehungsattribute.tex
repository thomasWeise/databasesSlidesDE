...
%
\item<5-> Es ist aber ziemlich klar, dass das entweder eine \crowsFoot{\emph{Person}}{OM}{\emph{ID Type}}{OM}- oder eine \crowsFoot{\emph{Person}}{OM}{\emph{ID Type}}{MM}-Beziehung wäre.%
%
