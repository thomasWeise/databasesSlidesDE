...
%
\begin{frame}%
\frametitle{\crowsFoot{C}{O1}{D: }{M1}Lösungen}%
\begin{itemize}%
...
%
\begin{frame}%
\frametitle{\crowsFoot{C}{O1}{D: }{M1}Zwei-Tabellen Lösung}%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{C}{O1}{D: }{M1}Befüllen mit Daten}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{C}{O1}{D: }{M1}Der Inhalt der Zwei Tabellen}%
%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{C}{O1}{D: }{M1}Testen der Einschränkungen}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
%
\only<-4>{%
