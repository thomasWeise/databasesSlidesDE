...
%
\begin{frame}%
\frametitle{\crowsFoot{E}{O1}{F: }{OM}Lösungen}%
\begin{itemize}%
...
\begin{frame}[t]%
\frametitle{\crowsFoot{E}{O1}{F: }{OM}Mit Drei Tabellen}%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{E}{O1}{F: }{OM}Befüllen mit Daten}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
%
...
%
\item<4-> Die Daten können dann wieder über zwei \sqlil{JOIN}s zusammengesetzt werden.%
%
\end{itemize}%
}%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{E}{O1}{F: }{OM}Der Inhalt der Drei Tabellen}%
%
...
%%
\begin{frame}%
\frametitle{\crowsFoot{E}{O1}{F: }{OM}Probleme mit der Drei-Tabellen-Methode}%
\begin{itemize}%
...
%
\begin{frame}%
\frametitle{\crowsFoot{E}{O1}{F: }{OM}Zwei-Tabellen Lösung}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
%
\only<-5>{%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{E}{O1}{F: }{OM}Der Inhalt der Zwei Tabellen}%
%
