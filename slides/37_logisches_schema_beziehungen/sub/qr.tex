...
\item<2-> Jede Entität vom Typ~Q muss mit mindestens einer Entität vom Typ~R verbunden sein, kann aber auch mit mehreren verbunden sein.
\item<3-> Jede Entität vom Typ~R kann mit keiner, einer, oder mehreren Entitäten vom Typ~Q verbunden sein.
...
%
\begin{frame}%
\frametitle{\crowsFoot{Q}{OM}{R: }{MM}Lösung}%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{Q}{OM}{R: }{MM}Befüllen mit Daten}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
\only<-5>{%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{Q}{OM}{R: }{MM}Der Inhalt der Drei Tabellen}%
%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{Q}{OM}{R: }{MM}Testen der Einschränkungen}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
%
