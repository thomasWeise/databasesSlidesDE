...
%
\begin{frame}%
\frametitle{\crowsFoot{M}{M1}{N: }{MM}Lösung}%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{M}{M1}{N: }{MM}Befüllen mit Daten}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
%
\only<-5>{%
...
\begin{frame}[t]%
\frametitle{\crowsFoot{M}{M1}{N: }{MM}Der Inhalt der Zwei Tabellen}%
%
%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{M}{M1}{N: }{MM}Testen der Einschränkungen}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
%
\only<-6>{%
