...
%
\begin{frame}%
\frametitle{\crowsFoot{O}{OM}{P: }{OM}Lösung}%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{O}{OM}{P: }{OM}Befüllen mit Daten}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{O}{OM}{P: }{OM}Der Inhalt der Drei Tabellen}%
%
...
%
\begin{frame}[t]%
\frametitle{\crowsFoot{O}{OM}{P: }{OM}Testen der Einschränkungen}%
\parbox{0.435\linewidth}{\small%
\begin{itemize}%
%
\only<-4>{%
