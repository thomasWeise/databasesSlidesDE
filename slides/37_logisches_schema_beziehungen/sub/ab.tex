...
\begin{itemize}%
%
\item Wir haben eine Pizzaria bei der Kunden online bestellen können.\uncover<6->{ %
Wir geben Gutscheine heraus, die die Bestellkostem um 20\% reduzieren.\uncover<7->{ %
...
%
\begin{frame}[t]%
\frametitle{Zwei Realisierungen}%
\begin{itemize}%
