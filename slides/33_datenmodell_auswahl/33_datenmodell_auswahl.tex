...
\begin{itemize}%
\item In der frühen Entwicklung des Gebiets der Datenbanken entstanden hierarchische Datenbanken wie \glsShort{softIMS}\cite{KLBGNLWBS2012ITIYCGTIIMS,BBP2007TBOI,KC2024DS:ITD}.%
%
...
\begin{itemize}%
\item Ein weiterer historischer Ansatz ist das Netzwerkdatenmodell, das aus \glsShort{softIDS}\cite{B2009TOOTIDSITFDAD,B1965SFRAP,H2016HCBITDAFOODW} und CODASYL\cite{TF1976CDBMS} entstand.%
%
...
\begin{itemize}%
\only<-8>{%
\item Der Fokus unseres Kurses ist auf dem \glslink{rdb}{relationalen} Datenmodell, das \citeauthor{C1970ARMODFLSDB}\cite{C1970ARMODFLSDB} erfunden hat und der Sprache \glsShort{SQL}.%
}%
%
