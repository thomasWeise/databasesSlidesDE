...
\item<2-> \glsShort{IDS} war die erste Direktzugriffsdatenbank und hielt Daten im virtuellen Speicher.%
...
\begin{itemize}%
\item \glsShort{IDS} strukturiert Daten als ein Netzwerk und kann so komplexe Beziehungen abbilden.%
...
\item<5-> \glsShort{IDS} war also nicht so flexibel.%
\item<6-> Die Database Task Group der Conference on Data Systems Languages~(CODASYL)\cite{TF1976CDBMS} war eine Standardisierungsgruppe der datenverarbeitenden Industry und übernahm \citeauthor{B2009TOOTIDSITFDAD}'s Ideen hinter dem \glsShort{IDS} in den 1960ern.%
...
\begin{itemize}%
\item Kurz nach \glsShort{IDS} kam ein anderes System auf den Markt, das ebenfalls struturierte Daten speichern konnte.%
...
\frametitle{Information Management System}%
\begin{itemize}%
\item Wie \glsShort{IDS} ist auch das \glsShort{IMS} kein relationales Datenbankmanagementsystem.%
...
\begin{itemize}%
\item Sowohl \glsShort{IDS} als auch \glsShort{IMS} haben wichtige Beiträge geleistet.%
