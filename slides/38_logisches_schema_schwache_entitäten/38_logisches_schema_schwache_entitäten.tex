...
\toggleToGerman%
%
\subtitle{38.~Logisches Schema:~Schwache Entitäten}%
%
\begin{document}%
%
\startPresentation%
...
\begin{itemize}%
%
\item Schwache Entitätstypen sind immer mit mindestens einer identifizierenden Beziehung mit einem starken Entitätstyp verbunden\cite{S2024D:MEDTRDM}~(oder mit einem anderen schwachen Entitätstyp der identifiziert werden kann).%
%
