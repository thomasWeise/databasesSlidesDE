...
\end{itemize}%
%
\gitPythonAndOutput{3-}{\programmingWithPythonCodeRepo}{veryFirstProject}{very_first_program.py}{--args format}{0.05}{0.5}{0.9}{0.8}%
%
\end{frame}
%
\begin{frame}%
...
\begin{itemize}%
\item Für einige Beispiele mit komplexeren Kommandos werden der Programmkode, die Kommandozeile zu dessen Ausführung, der \pgls{stdout}, der Exit-Kode, und die Softwareversion mit angezeigt.%
...
\item<2-> Aktuell gibt es folgende beiden Kurse\uncover<3->{:%
\begin{itemize}%
\item \python, mit dem Textbuch \emph{\furtherReading{programmingWithPython}}\uncover<4->{ und}%
