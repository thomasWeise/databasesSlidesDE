...
%
\begin{frame}%
\frametitle{Alternative: Repository Klonen}%
\begin{itemize}%
\item Wie gesagt können Sie alle Beispiele dieses Kurses im \github-Repository \expandafter\url{\databasesCodeRepo} finden.%
\item<2-> Wenn Sie viel mit \python\ arbeiten, dann benutzen Sie vielleicht die \glslink{ide}{IDE} \pycharm.%
\item<3-> Sie können das Repository auch direkt als Projekt in \pycharm\ herunterladen~(klonen).%
\item<4-> Diesen Ansatz diskutieren wir im Slide-Set \alert{14.~\psycopg\ Installieren}, wo wir auch vorstellen, wie die vom Beispielprojekt genutzten \python-Pakete mit installiert werden können.%
\end{itemize}%
\end{frame}%
%
