...
Eine funktionale Abhängigkeit~(\glsShort{funcDep}) ist eine Beziehung zwischen zwei Gruppen von Attributen~$X$ und $Y$, wobei gilt, dass für jede Instanz von~$X$ der Wert von~$X$ den Wert von~$Y$ bestimmt\cite{S2024D:RNDAFDNF}. %
