...
%
\item<7-> Wir wollen dann einen schnellen und billigen Prototyp unserer Applikation, mit dem wir zumindest Daten erstellen und auslesen können.%
\end{itemize}%
\end{frame}%
%
%
...
%
\item<10-> Und dann können wir diese coolen Werkzeuge benutzen, um mit einer Datenbank in einem professionellem \glsShort{dbms} zu arbeiten.%
%
