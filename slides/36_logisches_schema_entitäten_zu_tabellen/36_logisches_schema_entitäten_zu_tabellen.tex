...
%
\item<3-> Wir werden Sicheten, Anfragen, und Einfüge-Regeln für unsere Daten entwerfen müssen.%
%
...
%
\item<5-> Unter \ubuntu\ \linux\ gegen wir dafür \bashil{pgmodler} im \glslink{terminal}{Terminal} ein drücken~\keys{\return}.%
}%
%
\only<-6>{%
...
\begin{itemize}%
\only<-3>{%
\item Wir sind dabei, Entitätstypen zum relatinalen Datenmodell zu übersetzen.%
}%
