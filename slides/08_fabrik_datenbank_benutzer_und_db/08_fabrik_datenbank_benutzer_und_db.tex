...
\begin{itemize}%
\item Und damit haben wir bereits unser erstes SQL-Kommando gelernt:~\sqlil{CREATE USER}.%
\item<2-> Es hat die folgende Syntax:%
\end{itemize}%
\gitLoadSQL{syntax:create_user}{}{syntax/create_user.sql}%
\asSyntax{\listingSQL{2}{syntax:create_user}{0.05}{0.3}{0.9}{0.6}}%
\end{frame}
%
\begin{frame}[t]%
\frametitle{Erstellen des Benutzers via Terminal}%
...
\item<2-> Es hat die folgende Syntax:%
\end{itemize}%
\gitLoadSQL{syntax:select_from}{}{syntax/select_from.sql}%
\asSyntax{\listingSQL{2}{syntax:select_from}{0.05}{0.3}{0.9}{0.6}}%
\end{frame}
%
\begin{frame}[t]%
...
%
\begin{frame}[fragile,t]
\frametitle{CREATE DATABASE}%
\begin{itemize}%
\item Und nun kennen wir das dritte SQL-Kommando:~\sqlil{CREATE DATABASE}.%
\item<2-> Es hat die folgende Syntax:%
\end{itemize}%
\gitLoadSQL{syntax:create_database}{}{syntax/create_database.sql}%
\asSyntax{\listingSQL{2}{syntax:create_database}{0.05}{0.3}{0.9}{0.6}}%
\end{frame}
%
