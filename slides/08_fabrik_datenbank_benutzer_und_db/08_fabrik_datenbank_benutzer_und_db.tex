...
\end{itemize}%
\sqlSyntax{2-}{syntax/create_user_de.sql}{0.05}{0.4}{0.9}{0.55}%
\end{frame}
%
\begin{frame}%
...
\only<4>{\item<4-> Wir beenden die \psql-Session durch \textil{\\q} und \keys{\return}.}%
...
\end{itemize}%
\sqlSyntax{3-}{syntax/create_database_de.sql}{0.05}{0.4}{0.9}{0.55}%
\end{frame}
%
\begin{frame}[t]%
...
\only<11>{\item<11-> Wir beenden die \psql-Session durch \textil{\\q} und \keys{\return}.}%
