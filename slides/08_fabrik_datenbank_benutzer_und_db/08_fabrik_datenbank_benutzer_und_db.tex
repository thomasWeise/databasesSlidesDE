...
\end{itemize}%
\sqlSyntax{2}{syntax:create_user}{syntax/create_user.sql}{0.05}{0.3}{0.9}{0.6}%
\end{frame}
%
\begin{frame}[t]%
\frametitle{Erstellen des Benutzers via Terminal}%
...
\item<2-> Es hat die folgende Syntax:%
\end{itemize}%
\sqlSyntax{2}{syntax:select_from}{syntax/select_from.sql}{0.05}{0.3}{0.9}{0.6}%
\end{frame}
%
\begin{frame}[t]%
...
\item<2-> Es hat die folgende Syntax:%
\end{itemize}%
\sqlSyntax{2}{syntax:create_database}{syntax/create_database.sql}{0.05}{0.3}{0.9}{0.6}%
\end{frame}
%
