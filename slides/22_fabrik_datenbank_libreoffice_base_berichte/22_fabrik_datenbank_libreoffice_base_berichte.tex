...
\begin{itemize}%
\only<-9>{%
\item Das letzte oft verwendete Element in kleineren \glsShort{db}-Applikationen, das wir uns anschauen, sind Berichte~\inEN{reports}.%
}%
%
...
%
\only<-8>{%
\item<7-> Wir bekommen alle Spalten der Sicht angezeigt und selektieren sie auch alle.%
%
...
%
\item<60-> Wir können es nach \pgls{formatPDF} exportieren, in dem wir das PDF-Symbol \libreOfficePdf\ anklicken.%
}%
%
